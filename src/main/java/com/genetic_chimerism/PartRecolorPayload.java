...
public record PartRecolorPayload(MutatableParts part,int patternIndex, int color1, int color2) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, PartRecolorPayload> PART_RECOLOR_CODEC = PacketCodec.tuple(MutatableParts.MUTATABLE_PARTS_PACKET_CODEC, PartRecolorPayload::part, PacketCodecs.INTEGER, PartRecolorPayload::patternIndex, PacketCodecs.INTEGER, PartRecolorPayload::color1, PacketCodecs.INTEGER, PartRecolorPayload::color2, PartRecolorPayload::new);
