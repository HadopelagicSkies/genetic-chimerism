...
public class ArmMutationFeatureRenderer extends FeatureRenderer<PlayerEntityRenderState, PlayerEntityModel> {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, PlayerEntityRenderState state, float limbAngle, float limbDistance) {
        ...
        if(accessedState.genetic_chimerism$getArmInfo() != null) {
            TexturedModelData modelData = MutationTreesClient.mutationFromCodec(accessedState.genetic_chimerism$getArmInfo()).getTexturedModelData();
            Identifier texture = MutationTreesClient.mutationFromCodec(accessedState.genetic_chimerism$getArmInfo()).getTexture();
            ModelPart modelL = modelData.createModel();
            this.getContextModel().leftArm.copyTransform(modelL);
            ...
            this.getContextModel().rightArm.copyTransform(modelR);
