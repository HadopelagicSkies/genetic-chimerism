...
public class SpinedTreeClient {
    ...
    public static final MutationClient smallSpines = spined.addToTree(new SmallSpinesMutation("smallSpines", "spined"));
    ...
    public static class SmallSpinesMutation extends MutationClient {
        public SmallSpinesMutation(String mutID, String treeID) {
            super(mutID, treeID);
        }

        @Override
        public Identifier getTexture1() {
            return Identifier.of(GeneticChimerism.MOD_ID, "textures/body_part/small_spines1.png");
        }

        @Override
        public Identifier getTexture2() {
            return Identifier.of(GeneticChimerism.MOD_ID, "textures/body_part/small_spines2.png");
        }
        ...
        public TexturedModelData getTexturedModelData() {
            ...
            ModelPartData bone = modelPartData.addChild("bone", ModelPartBuilder.create(), ModelTransform.pivot(2.5F, 1.5F, 1.0F));
            ModelPartData cube_r1 = bone.addChild("cube_r1", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.5236F, 0.1745F, 0.0F));
            ModelPartData bone2 = modelPartData.addChild("bone2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 1.5F, 1.0F));
            ModelPartData cube_r2 = bone2.addChild("cube_r2", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.5236F, 0.0F, 0.0F));
            ModelPartData bone3 = modelPartData.addChild("bone3", ModelPartBuilder.create(), ModelTransform.pivot(-2.5F, 1.5F, 1.0F));
            ModelPartData cube_r3 = bone3.addChild("cube_r3", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.5236F, -0.1745F, 0.0F));
            ModelPartData bone4 = modelPartData.addChild("bone4", ModelPartBuilder.create(), ModelTransform.pivot(-1.25F, 3.0F, 1.0F));
            ModelPartData cube_r4 = bone4.addChild("cube_r4", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.6109F, -0.0873F, 0.0F));
            ModelPartData bone5 = modelPartData.addChild("bone5", ModelPartBuilder.create(), ModelTransform.pivot(1.25F, 3.0F, 1.0F));
            ModelPartData cube_r5 = bone5.addChild("cube_r5", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.6109F, 0.0873F, 0.0F));
            ModelPartData bone6 = modelPartData.addChild("bone6", ModelPartBuilder.create(), ModelTransform.pivot(1.25F, 6.0F, 1.0F));
            ModelPartData cube_r6 = bone6.addChild("cube_r6", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.6981F, 0.0873F, 0.0F));
            ModelPartData bone7 = modelPartData.addChild("bone7", ModelPartBuilder.create(), ModelTransform.pivot(2.5F, 4.5F, 1.0F));
            ModelPartData cube_r7 = bone7.addChild("cube_r7", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.6545F, 0.1745F, 0.0F));
            ModelPartData bone8 = modelPartData.addChild("bone8", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 4.5F, 1.0F));
            ModelPartData cube_r8 = bone8.addChild("cube_r8", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.6545F, 0.0F, 0.0F));
            ModelPartData bone9 = modelPartData.addChild("bone9", ModelPartBuilder.create(), ModelTransform.pivot(-2.5F, 4.5F, 1.0F));
            ModelPartData cube_r9 = bone9.addChild("cube_r9", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.6545F, -0.1745F, 0.0F));
            ModelPartData bone10 = modelPartData.addChild("bone10", ModelPartBuilder.create(), ModelTransform.pivot(-1.25F, 6.0F, 1.0F));
            ModelPartData cube_r10 = bone10.addChild("cube_r10", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.6981F, -0.0873F, 0.0F));
            ModelPartData bone11 = modelPartData.addChild("bone11", ModelPartBuilder.create(), ModelTransform.pivot(2.5F, 7.5F, 1.0F));
            ModelPartData cube_r11 = bone11.addChild("cube_r11", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.7854F, 0.1745F, 0.0F));
            ModelPartData bone12 = modelPartData.addChild("bone12", ModelPartBuilder.create(), ModelTransform.pivot(-2.5F, 7.5F, 1.0F));
            ModelPartData cube_r12 = bone12.addChild("cube_r12", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.7854F, -0.1745F, 0.0F));
    ...
    public static class GuardianSpikes1Mutation extends MutationClient {
        ...
        public Animation createGrowthAnimation() {
            return Animation.Builder.create(1.0F)
                    ...
                    .addBoneAnimation("bone5", new Transformation(Transformation.Targets.SCALE,
                            new Keyframe(0.0F, AnimationHelper.createScalingVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
                            new Keyframe(0.25F, AnimationHelper.createScalingVector(0.75F, 0.75F, 0.75F), Transformation.Interpolations.LINEAR),
                            new Keyframe(0.75F, AnimationHelper.createScalingVector(0.75F, 0.75F, 0.75F), Transformation.Interpolations.LINEAR),
                            new Keyframe(1.0F, AnimationHelper.createScalingVector(1.0F, 1.0F, 1.0F), Transformation.Interpolations.LINEAR)
                    ))
                    .addBoneAnimation("bone7", new Transformation(Transformation.Targets.SCALE,
                            new Keyframe(0.0F, AnimationHelper.createScalingVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
